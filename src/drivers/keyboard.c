/*
    ...
    * ABSTRACT:
    * 
    *   -> Implements a simple keyboard driver using the US keyboard layout.
    * 
...
// Thanks to https://gist.github.com/davazp/d2fde634503b2a5bc664
...
void KeyboardDriver(int scancode)
{
    if (scancode < 0x81) // pressed
    {
        if (!shiftpressed)
        {
